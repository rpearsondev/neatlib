use crate::{cpu_phenome::{node_index_lookup::NodePositionLookup, phenome_layer::PhenomeLayer}, common::{network_definition_node_layer_resolver::NetworkDefinitionNodeLayerResolver, network_definition::{NetworkDefinition, NetworkDefinitionNode}, NeatFloat}, node_kind::NodeKind, phenome::Phenome};
use uuid::Uuid;

#[derive(Debug, Clone, Default)]
pub struct CpuPhenome{
    pub id: Uuid,
